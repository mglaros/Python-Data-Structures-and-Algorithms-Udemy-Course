...
class Edge:
	...
	#Kruskal algorithm needs to compare weights
...
class DisjointSet:
	...
	def find(self, node):
		...
		#path compression to make O(1) lookup with subsequent find calls
	...
	def merge(self, node1, node2):
		...
		if index1 == index2:
			return #node1 and node2 in same set already
...
class KruskalAlgorithm:
	def spanningTree(self, vertexList, edgeList):
		...
		spanningTree = []
		edgeList.sort() #why we need comparator operator overidden
